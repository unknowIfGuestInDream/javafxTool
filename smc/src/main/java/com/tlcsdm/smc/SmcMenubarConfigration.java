...
public class SmcMenubarConfigration implements MenubarConfigration {
	...
	private final Action openSysConfigDir = new Action(I18nUtils.get("smc.menubar.help.openSysConfigDir"),
			actionEvent -> JavaFxSystemUtil.openDirectory(ConfigureUtil.getConfigurePath()));
	...
	private final Collection<? extends Action> actions = List.of(
			...
			new ActionGroup(I18nUtils.get("smc.menubar.help"), getImageView("/com/tlcsdm/smc/static/menubar/help.png"),
					openSysConfigDir, openLogDir, ACTION_SEPARATOR, contactSupport, submitFeedback, ACTION_SEPARATOR,
					release, about));
	...
	private void initActions() {
		...
		openSysConfigDir.setGraphic(getImageView("/com/tlcsdm/smc/static/menubar/folder.png"));
