...
public class FileDiff extends SmcSample {
	...
	public Node getPanel(Stage stage) {
		...
		Button originalButton = new Button(I18nUtils.get("smc.tool.fileDiff.button.choose"));
		...
		Button compareButton = new Button(I18nUtils.get("smc.tool.fileDiff.button.choose"));
		...
		Button outputButton = new Button(I18nUtils.get("smc.tool.fileDiff.button.choose"));
